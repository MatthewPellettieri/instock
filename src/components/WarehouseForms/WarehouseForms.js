			...
			<form onSubmit={submitHandler}>
				<div className="warehouseForms__container">
					<div className="warehouseForms__form">
						...
						<textarea  onChange={changeHandler} name="warehouseName" placeholder="Warehouse Name" className="warehouseForms__form--input" defaultValue={warehouseName}></textarea>
						<p className="warehouseForms__form--noerrorText" name="warehouseName_error"><img src={errorIcon} alt="errorIcon"/>This feild is required</p>

						<h3 className="warehouseForms__form--label">Street Address</h3>
						<textarea  onChange={changeHandler} name="streetAddress" placeholder="Street Address" className="warehouseForms__form--input" defaultValue={address}></textarea>
						<p className="warehouseForms__form--noerrorText" name="streetAddress_error"><img src={errorIcon} alt="errorIcon"/>This feild is required</p>

						<h3 className="warehouseForms__form--label">City</h3>
						<textarea onChange={changeHandler} name="city" placeholder="City" className="warehouseForms__form--input" defaultValue={city}></textarea>
						<p className="warehouseForms__form--noerrorText" name="city_error"><img src={errorIcon} alt="errorIcon"/>This feild is required</p>

						<h3 className="warehouseForms__form--label">Country</h3>
						<textarea onChange={changeHandler} name="country" placeholder="Country" className="warehouseForms__form--input" defaultValue={country}></textarea>
						<p className="warehouseForms__form--noerrorText" name="country_error"><img src={errorIcon} alt="errorIcon"/>This feild is required</p>
					</div>
					...
					<div className="warehouseForms__form">
						...
						<textarea onChange={changeHandler} name="contactName" placeholder="Contact Name" className="warehouseForms__form--input" defaultValue={contact}></textarea>
						<p className="warehouseForms__form--noerrorText" name="contactName_error"><img src={errorIcon} alt="errorIcon"/>This feild is required</p>

						<h3 className="warehouseForms__form--label">Position</h3>
						<textarea onChange={changeHandler} name="position" placeholder="Position" className="warehouseForms__form--input" defaultValue={position}></textarea>
						<p className="warehouseForms__form--noerrorText" name="position_error"><img src={errorIcon} alt="errorIcon"/>This feild is required</p>

						<h3 className="warehouseForms__form--label">Phone Number</h3>
						<textarea onChange={changeHandler} name="phoneNumber" placeholder="Phone Number" className="warehouseForms__form--input" defaultValue={phone}></textarea>
						<p className="warehouseForms__form--noerrorText" name="phoneNumber_error"><img src={errorIcon} alt="errorIcon"/>This feild is required</p>

						<h3 className="warehouseForms__form--label">Email</h3>
						<textarea onChange={changeHandler} name="email" placeholder="Email" className="warehouseForms__form--input" defaultValue={email}></textarea>
						<p className="warehouseForms__form--noerrorText" name="email_error"><img src={errorIcon} alt="errorIcon"/>This feild is required</p>
					</div>
				</div>
